...
const StatsBlock = ({ count, description }) => {
    return (
        <div className="320:w-[90px] 320:h-[90px] 768:w-[140px] 768:h-[120px] 1024:w-[180px] relative h-[120px] w-[140px] flex-shrink-0 bg-black shadow-md 2xl:h-[180px] 2xl:w-[190px]">
