      ...
      <div className="relative top-[200px] -z-10 w-full smMd:top-[47px] 2lg:-top-[200px]  xl:-top-[280px]  xxlg:-top-[338px]">
        ...
        >
          ...
          >
            ...
            trip unforgettable. Whether it's a wedding, corporate event, or a
            night out on the town, we've got you covered. Don't wait any longer;
          ...
          <div className="mt-10 flex w-full cursor-pointer items-center justify-center">
            <button
              className={`mt- bg-crimson cursor-pointer px-5 py-3 text-xs text-white outline-none sm:me-5 sm:px-14 sm:text-base xxlg:px-16 xxlg:py-4 ${montserrat500}`}
              onClick={handleReserveNowClick} // Call handleReserveNowClick on button click
            >
              RESERVE NOW
            </button>
          </div>
